...
void HomeTimelineHandler::WriteHomeTimeline(
  ...
  try {
    ...
    LOG(info) << "HomeTimeline2WriteHomeTimeline-SocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
...

  {
    if (_redis_client_pool) {
      ...
      try {
        ...
        auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
        LOG(info) << "HomeTimeline2WriteHomeTimeline-redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  LOG(info) << "HomeTimeline2WriteHomeTimeline starttime=" << starttime << " endtime=" << endtime;
...
void HomeTimelineHandler::ReadHomeTimeline(
  ...
  try {
    if (_redis_client_pool) {      
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "HomeTimeline2ReadHomeTimeline-redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  try {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "HomeTimeline2ReadHomeTimeline-PostStorage conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "HomeTimeline2ReadHomeTimeline starttime=" << starttime << " endtime=" << endtime;
