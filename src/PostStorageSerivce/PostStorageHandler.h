...
void PostStorageHandler::StorePost(
  ...
  LOG(info) << "PostStorage2StorePost-MongoDB conn_starttime=" << conn_starttime << " conn_endtime=" << conn_endtime;
  ...
  LOG(info) << "PostStorage2StorePost starttime=" << starttime << " endtime=" << endtime;
...
void PostStorageHandler::ReadPost(
  ...
  auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
  LOG(info) << "PostStorage2ReadPost-Memcached conn_starttime=" << conn_starttime << " conn_endtime=" << conn_endtime;
  ...
  if (post_mmc) {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
    LOG(info) << "PostStorage2ReadPost-MongoDB conn_starttime=" << conn_starttime << " conn_endtime=" << conn_endtime;
    ...
    if (!found) {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
      LOG(info) << "PostStorage2ReadPost-UploadToMemcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
  LOG(info) << "PostStorage2ReadPost starttime=" << starttime << " endtime=" << endtime;
...
void PostStorageHandler::ReadPosts(
  ...
  auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
  LOG(info) << "PostStorage2ReadPosts-Memcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (!post_ids_not_cached.empty()) {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
    LOG(info) << "PostStorage2ReadPosts-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
    ...
    set_futures.emplace_back(std::async(std::launch::async, [&]() {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
      LOG(info) << "PostStorage2ReadPosts-UploadToMemcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	
  LOG(info) << "PostStorage2ReadPosts starttime=" << starttime << " endtime=" << endtime;
