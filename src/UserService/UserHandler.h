...
void UserHandler::RegisterUserWithId(
  ...
  if (mongoc_cursor_error(cursor, &error)) {
    ...
    LOG(info) << "UserService2RegisterUserWithId-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  LOG(info) << "UserService2RegisterUserWithId starttime=" << starttime << " endtime=" << endtime;
...
void UserHandler::RegisterUser(
  ...
  auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "UserService2RegisterUser-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (!found) {
    ...
    try {
      ...
      social_graph_client->InsertUser(req_id, user_id, writer_text_map);
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << " UserService2RegisterUser-SocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
    ...
    auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2RegisterUser starttime=" << starttime << " endtime=" << endtime;
}
...
void UserHandler::ComposeCreatorWithUsername(
  ...
  if (memcached_client) {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2ComposeCreatorWithUsername-Memcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  // If not cached in memcached
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2ComposeCreatorWithUsername-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (memcached_client) {
    if (user_id != -1 && !cached) {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "UserService2ComposeCreatorWithUsername-UpdateMemcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "UserService2ComposeCreatorWithUsername starttime=" << starttime << " endtime=" << endtime;
...
void UserHandler::ComposeCreatorWithUserId(
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "UserService2ComposeCreatorWithUserId starttime=" << starttime << " endtime=" << endtime;
...
void UserHandler::Login(std::string &_return, int64_t req_id,
  ...
  if (!memcached_client) {
    ...
    login_mmc = memcached_get(memcached_client, (username + ":login").c_str(),
                              ...
                              &memcached_flags, &memcached_rc);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2Login-Memcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (login_mmc) {
    ...
    bool found = mongoc_cursor_next(cursor, &doc);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2Login-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (!cached) {
    ...
    if (!memcached_client) {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "UserService2Login-UpdateMemcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "UserService2Login starttime=" << starttime << " endtime=" << endtime;
...
int64_t UserHandler::GetUserId(
  ...
  if (memcached_client) {
    ...
    user_id_mmc =
        memcached_get(memcached_client, (username + ":user_id").c_str(),
                      ...
                      &memcached_flags, &memcached_rc);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2GetUserId-Memcached conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  if (user_id_mmc) {
    ...
    bool found = mongoc_cursor_next(cursor, &doc);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "UserService2GetUserId-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "UserService2GetUserId starttime=" << starttime << " endtime=" << endtime;
