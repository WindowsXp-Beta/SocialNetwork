...
void SocialGraphHandler::Follow(
  ...
  std::future<void> mongo_update_follower_future =
      std::async(std::launch::async, [&]() {
        ...
        auto conn_starttime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();	 
        ...
        auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
        LOG(info) << "SocialGraph2Follow-followerMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  std::future<void> mongo_update_followee_future =
      std::async(std::launch::async, [&]() {
        ...
        bool updated = mongoc_collection_find_and_modify(
            ...
            false, true, &reply, &error);
        auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
        LOG(info) << "SocialGraph2Follow-followeeMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
...

    {
      if (_redis_client_pool) {
        ...
        try {
          ...
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << "SocialGraph2Follow-Redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  LOG(info) << "SocialGraph2Follow starttime=" << starttime << " endtime=" << endtime;
}
...
void SocialGraphHandler::Unfollow(
  ...
  std::future<void> mongo_update_follower_future =
      std::async(std::launch::async, [&]() {
        ...
        bool updated = mongoc_collection_find_and_modify(
            ...
            &reply, &error);
        auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
        LOG(info) << "SocialGraph2Unfollow-followerMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  std::future<void> mongo_update_followee_future =
      std::async(std::launch::async, [&]() {
        ...
        bool updated = mongoc_collection_find_and_modify(
            ...
            &reply, &error);
        auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
        LOG(info) << "SocialGraph2Unfollow-followeeMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
        ...
        {opentracing::ChildOf(&span->context())});
    {
      if (_redis_client_pool) {
        ...
        try {
          ...
          auto replies = pipe.exec();
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << "SocialGraph2Unfollow-Redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2Unfollow starttime=" << starttime << " endtime=" << endtime;
...
void SocialGraphHandler::GetFollowers(
  ...
  try {
    if (_redis_client_pool) {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "SocialGraph2GetFollowers-Redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  // update Redis.
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "SocialGraph2GetFollowers-ReadMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
    ...
    if (found) {
      ...
      try {
        if (_redis_client_pool) {
          ...
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << "SocialGraph2GetFollowers-UpdateRedis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2GetFollowers starttime=" << starttime << " endtime=" << endtime;
...
void SocialGraphHandler::GetFollowees(
  ...
  try {
    if (_redis_client_pool) {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "SocialGraph2GetFollowees-Redis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  // update Redis.
    ...
    bool found = mongoc_cursor_next(cursor, &doc);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "SocialGraph2GetFollowees-ReadMongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
    ...
    if (!found) {
      ...
      try {
        if (_redis_client_pool) {
          ...
          _redis_client_pool->zadd(key, redis_zset.begin(), redis_zset.end());
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << "SocialGraph2GetFollowees-UpdateRedis conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2GetFollowees starttime=" << starttime << " endtime=" << endtime;
...
void SocialGraphHandler::InsertUser(
  ...
  bool inserted = mongoc_collection_insert_one(collection, new_doc, nullptr,
                                               nullptr, &error);
  auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2InsertUser-MongoDB conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2InsertUser starttime=" << starttime << " endtime=" << endtime;
...
void SocialGraphHandler::FollowWithUsername(
  ...
  std::future<int64_t> user_id_future = std::async(std::launch::async, [&]() {
    ...
    try {
      ...
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << "SocialGraph2FollowWithUsername-userIdSocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  std::future<int64_t> followee_id_future =
      std::async(std::launch::async, [&]() {
        ...
        try {
          ...
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << "SocialGraph2FollowWithUsername-followeeIdSocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2FollowWithUsername starttime=" << starttime << " endtime=" << endtime;
...
void SocialGraphHandler::UnfollowWithUsername(
  ...
  std::future<int64_t> user_id_future = std::async(std::launch::async, [&]() {
    ...
    try {
      ...
      _return = user_client->GetUserId(req_id, user_name, writer_text_map);
      auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
      LOG(info) << " SocialGraph2UnfollowWithUsername-userIdSocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  std::future<int64_t> followee_id_future =
      std::async(std::launch::async, [&]() {
        ...
        try {
          ...
          _return = user_client->GetUserId(req_id, followee_name, writer_text_map);
          auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
          LOG(info) << " SocialGraph2UnfollowWithUsername-followeeIdSocialGraph conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  span->Finish();
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "SocialGraph2UnfollowWithUsername starttime=" << starttime << " endtime=" << endtime;
}
