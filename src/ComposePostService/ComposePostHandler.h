...
Creator ComposePostHandler::_ComposeCreaterHelper(
  ...
  try {
    ...
    LOG(info) << "ComposePost2ComposeCreater-UserService conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  LOG(info) << "ComposePost2ComposeCreater starttime=" << starttime << " endtime=" << endtime;
...
TextServiceReturn ComposePostHandler::_ComposeTextHelper(
  ...
  try {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2ComposeText-TextService conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2ComposeText starttime=" << starttime << " endtime=" << endtime;
...
std::vector<Media> ComposePostHandler::_ComposeMediaHelper(
  ...
  try {
    ...
    media_client->ComposeMedia(_return_media, req_id, media_types, media_ids,
                               writer_text_map);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2ComposeMedia-MediaService conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2ComposeMedia starttime=" << starttime << " endtime=" << endtime;
...
int64_t ComposePostHandler::_ComposeUniqueIdHelper(
  ...
  try {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2ComposeUniqueID-UniqueIDService conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2ComposeUniqueID starttime=" << starttime << " endtime=" << endtime;
...
void ComposePostHandler::_UploadPostHelper(
  ...
  try {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2UploadPost-PostStorage conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2UploadPost starttime=" << starttime << " endtime=" << endtime;
...
void ComposePostHandler::_UploadUserTimelineHelper(
  ...
  try {
    ...
    user_timeline_client->WriteUserTimeline(req_id, post_id, user_id, timestamp,
                                            writer_text_map);
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2UploaduserTimeline-UserTimeline conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2UploaduserTimeline starttime=" << starttime << " endtime=" << endtime;
...
void ComposePostHandler::_UploadHomeTimelineHelper(
  ...
  try {
    ...
    auto conn_endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
    LOG(info) << "ComposePost2UploadHomeTimeline-HomeTimeline conn_starttime=" << conn_starttime << "conn_endtime=" << conn_endtime;
  ...
  auto endtime = duration_cast<milliseconds>(system_clock::now().time_since_epoch()).count();
  LOG(info) << "ComposePost2UploadHomeTimeline starttime=" << starttime << " endtime=" << endtime;
